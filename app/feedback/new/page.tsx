...
async function submitFeedback(
    ...
    try{
        ...
        toast.success("Your feedback has been submitted submitted successfully");
                ...
                <CardContent>
                    <form action={action} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <select id="category" name="category" className="w-full px-3 py-3 border rounded-md bg-background" defaultValue={CATEGORIES_TYPES[0]}>
